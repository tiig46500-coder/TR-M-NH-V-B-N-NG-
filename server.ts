...
Hành động nhỏ hôm nay: Tắt máy tính sớm hơn 15 phút, vươn vai thật dài và uống một cốc nước mát nhé. Tớ luôn tự hào vì nỗ lực thầm lặng của cậu! 🌸🌿`,
  ...
  app.post("/api/summarize-journey", async (req, res) => {
    try {
      ...
      const systemInstruction = `
Bạn là "Cozy" - người bạn tâm hồn, nhà tư vấn và khai vấn chánh niệm thấu cảm của dự án "Trạm Định Vị Bản Ngã" (Identity Compass).
...
`;
      ...
      let summaryText = `Chào ${name}, nhìn lại hành trình của cậu, Cozy thấy một tinh thần vô cùng dũng cảm. Việc cậu dành ra ${detoxMinutes} phút quý báu để thải độc số, ngắt kết nối với thế giới ồn ào và tập trung vào thế giới nội tâm là một nỗ lực đáng trân quý. Cây Bản Địa của cậu đã phát triển ở cấp độ ${plantStage}, phản ánh sinh động hạt mầm chánh niệm đang âm thầm lớn mạnh từng ngày. Việc ghi chép ${moodLogsCount} nhật ký cảm xúc chứng tỏ cậu đang học cách đối thoại và làm hòa với những gợn sóng tâm hồn mình.`;
      
      let cozyInsight = `Với năng lượng "${vibe}" hiện tại, Cozy mong cậu nhớ rằng: cảm xúc trồi sụt là một phần tự nhiên của hành trình định vị bản thân. Mục tiêu "${goal}" sẽ dần đạt được khi cậu duy trì những thói quen chỏ bé này. \n\nHành động nhỏ hôm nay dành riêng cho cậu: Hãy đặt điện thoại xuống, uống một ngụm nước ấm mát lành, và nhìn ra ngoài cửa sổ mỉm cười trong 5 giây nhé! Cozy luôn ở đây đồng hành cùng cậu. ✨`;
