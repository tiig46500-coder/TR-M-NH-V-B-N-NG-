...
export const HEALING_QUOTES: HealingQuote[] = [
  ...
  {
    id: 5,
    text: "Có một vết nứt trong mọi thứ, đó là nơi ánh sáng lọt vào. Những tổn thương hiện tại chính là cánh cửa dẫn cậu tới sự thấu cảm sâu sắc hơn với cuộc đời.",
